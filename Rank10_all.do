...
*LIST RANKINGS ACROSS SCENARIOS
sort event_seasonID WC_rank  skijumper_name
list skijumper_name event_seasonID *rank, sepby(event_seasonID)
...
spearman WC_rank `var' if WC_rank<=10
